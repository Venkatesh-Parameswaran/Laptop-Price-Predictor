...
st.markdown(
    ...
    .stApp {{
        background-color: rgba(100, 100, 100, 0.7); /* Semi-transparent background for Streamlit elements */
...
# Hero Image
hero_img_url = "https://i.pinimg.com/564x/9d/3e/72/9d3e727425f5cb0b8d77103ec0c486df.jpg"
st.markdown(
