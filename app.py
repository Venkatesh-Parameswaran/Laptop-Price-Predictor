...
background_image_url = "https://raw.githubusercontent.com/Venkatesh-Parameswaran/Laptop-Price-Predictor/main/laptop%20bk7.jpg"
...
st.markdown(
    ...
    .stApp {{
        background-color: rgba(255, 255, 255); /* Semi-transparent background for Streamlit elements */
