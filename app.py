...
st.markdown(
    ...
    .stApp {{
        background-color: rgba(75, 75, 75, 0.3); /* Semi-transparent background for Streamlit elements */
...
# Hero Image
hero_img_url = "https://i.pinimg.com/564x/3d/31/a2/3d31a2d013be4a447a6336fb13bc2eff.jpg"
st.markdown(
