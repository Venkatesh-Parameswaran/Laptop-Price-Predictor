...
background_image_url = "https://raw.githubusercontent.com/Venkatesh-Parameswaran/Laptop-Price-Predictor/main/laptop%20bk1.jpg"
...
st.markdown(
    ...
    .stApp {{
        background-color: rgba(255, 255, 255); /* Transparent background for Streamlit elements */
